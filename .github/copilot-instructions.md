...
- Prefer the mandated libraries in `README.md` (Stricli, Bun, Winston, picocolors, treeify, js-yaml) before adding new dependencies.
- Keep data artifacts consistent: JSONL per resource, YAML progress files, YAML-stored tokens, and document new flows under `docs/`.
