...
export {
  FetchComprehensiveProjectDocument as FETCH_COMPREHENSIVE_PROJECT_QUERY,
...
export type {
  FetchComprehensiveProjectQuery,
  FetchComprehensiveProjectQueryVariables,
  FetchComprehensiveProjectsQuery,
  FetchComprehensiveProjectsQueryVariables,
  FetchProjectIssuesQuery,
  FetchProjectIssuesQueryVariables,
