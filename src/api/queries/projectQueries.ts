...
/**
 * Comprehensive project query with verified GitLab GraphQL fields
 */
export const FETCH_COMPREHENSIVE_PROJECT_QUERY = graphql(`
...
/**
 * Query to fetch multiple projects with comprehensive data
 */
export const FETCH_COMPREHENSIVE_PROJECTS_QUERY = graphql(`
...
/**
 * Query to fetch project issues with comprehensive data
 */
export const FETCH_PROJECT_ISSUES_QUERY = graphql(`
...
/**
 * Query to fetch project merge requests with comprehensive data
 */
export const FETCH_PROJECT_MERGE_REQUESTS_QUERY = graphql(`
...
/**
 * Query to fetch project pipelines with comprehensive data
 */
export const FETCH_PROJECT_PIPELINES_QUERY = graphql(`
