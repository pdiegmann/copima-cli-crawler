  ...
  parameters: {
    ...
    flags: {
      ...
      groups: {
        kind: "parsed",
        parse: (input: string) => input,
        brief: "Comma-separated list of specific groups to crawl (e.g., group1,group2/subgroup)",
        optional: true,
      },
      "max-groups": {
        kind: "parsed",
        parse: (input: string) => parseInt(input, 10),
        brief: "Maximum number of groups to fetch (useful for large instances)",
        optional: true,
      },
      "max-projects": {
        kind: "parsed",
        parse: (input: string) => parseInt(input, 10),
        brief: "Maximum number of projects to fetch (useful for large instances)",
        optional: true,
      },
    },
  },
  ...
  parameters: {
    ...
    flags: {
      ...
      "max-users": {
        kind: "parsed",
        parse: (input: string) => parseInt(input, 10),
        brief: "Maximum number of users to fetch (useful for large instances)",
        optional: true,
      },
    },
  },
